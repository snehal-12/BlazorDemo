...
namespace BlazorDemoApp.Repository
{
    public static class ServerRepo
    {
        private static List<Server> servers = new List<Server>()
        {
            ...
            new Server {  Id = 5, Name = "Server 5", City = "Calhoun" },
            new Server {  Id = 6, Name = "Server 6", City = "Calhoun" },
            new Server {  Id = 7, Name = "Server 7", City = "Calhoun" },
            ...
            new Server {  Id = 12, Name = "Server 12", City = "WallaceSelma" },
            new Server {  Id = 13, Name = "Server 13", City = "WallaceSelma" },
            new Server {  Id = 14, Name = "Server 14", City = "Bishop" },
            new Server {  Id = 15, Name = "Server 15", City = "Bishop" },
        };
